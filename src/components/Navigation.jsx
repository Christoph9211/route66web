    ...
    const navigationItems = [
        ...
        },
        {
            ...
            submenu: [
                ...
                { label: 'Concentrates', href: '#concentrates', category: 'Concentrates' },
                { label: 'Diamonds & Sauce', href: '#diamonds', category: 'Diamonds & Sauce' },
                { label: 'Vapes & Carts', href: '#vapes', category: 'Vapes & Carts' },
                    ...
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex items-center">
                            ...
                            >
                                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-green-600">
                                    <i className="fas fa-cannabis text-white" aria-hidden="true" />
                                </div>
                            ...
                            <div className="ml-10 flex items-baseline space-x-4">
                                {navigationItems.map((item) => (
                                    <div key={item.id} className="relative group">
                                        ...
                                        >
                                            <i className={`${item.icon} mr-2 text-sm`} aria-hidden="true" />
                                            {item.label}
                                            {item.submenu && (
                                                <i className="fas fa-chevron-down ml-1 text-xs" aria-hidden="true" />
                                            )}
                                        </a>
                                        
                                        {/* Desktop Dropdown */}
                                        {item.submenu && (
                                            <div className="absolute left-0 mt-2 w-48 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 dark:bg-gray-800" role="menu" aria-label={`${item.label} submenu`}>
                                                <div className="py-1" role="none">
                                                    {item.submenu.map((subItem) => (
                                                        <a
                                                            key={subItem.label}
                                                            href={subItem.href}
                                                            onClick={(e) => handleNavClick(e, subItem.href, item.id)}
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="hidden lg:flex items-center space-x-4 text-sm">
                                ...
                                >
                                    <i className="fas fa-phone mr-1" aria-hidden="true" />
                                    (573) 677-6418
                                </a>
                            </div>
                            ...
                            <button
                                ...
                                className="md:hidden inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-green-600 hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500 dark:text-gray-300 dark:hover:text-green-400 dark:hover:bg-gray-700"
                            >
                ...
                <div className={`md:hidden transition-all duration-300 ease-in-out ${
                    ...
                    <div className="bg-white border-t border-gray-200 dark:bg-gray-900 dark:border-gray-700">
                        <div className="px-2 pt-2 pb-3 space-y-1">
                            {navigationItems.map((item) => (
                                <div key={item.id}>
                                    ...
                                    >
                                        <i className={`${item.icon} mr-3`} aria-hidden="true" />
                                        {item.label}
                                    </a>
                        ...
                        <div className="border-t border-gray-200 px-4 py-3 dark:border-gray-700">
                            <LocalBusinessInfo variant="minimal" className="text-gray-600 dark:text-gray-300" />
                        </div>
                    </div>
                </div>
            </header>
